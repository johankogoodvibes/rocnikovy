...
void solve_kempecycle(vector<vector<int>>& g, set<pair<int, int>>& solved, int a, int b) {
    ...
    if (c1 != c2) {
        ...
        {
            vector<int> cyklusa = get_kempe_cycle(g, a, c1, vyrovnatc), cyklusb = {b};
            solve_for_cycles(g, solved, a, b, cyklusa, cyklusb, c1, vyrovnatc);
        }
        {
            vector<int> cyklusa = {a}, cyklusb = get_kempe_cycle(g, b, c2, vyrovnatc);
            solve_for_cycles(g, solved, a, b, cyklusa, cyklusb, c2, vyrovnatc);
        }
